...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='/home/kbuyukburc/repo/POVGAN/dataset_256_256') 
        ...
        self.parser.add_argument('--tf_log', action='store_true', default=False, help='if specified, use tensorboard logging. Requires tensorflow installed')
